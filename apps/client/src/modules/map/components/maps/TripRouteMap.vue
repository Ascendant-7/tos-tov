...
import { calculateTripStats } from '@/modules/map/utils/tripStats.ts'
import type { MapDestination, RouteSummary, TripStats, TravelProfile } from '@/modules/map/types/maps.ts'
