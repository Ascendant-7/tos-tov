...
const tabs = ['All', 'Beach', 'Temple', 'Nature', 'City', 'Adventure']

const weatherData = [
  { city: 'Siem Reap', temp: 32, condition: 'Sunny', icon: '☀️', bgClass: 'bg-amber-50' },
  { city: 'Phnom Penh', temp: 31, condition: 'Partly Cloudy', icon: '⛅', bgClass: 'bg-slate-50' },
...
const destinations = [
  { name: 'Angkor Wat', location: 'Siem Reap', rating: '4.9', tags: ['Temple', 'UNESCO'], category: 'Temple', image: '' },
  { name: 'Koh Rong Island', location: 'Preah Sihanouk', rating: '4.7', tags: ['Beach', 'Island'], category: 'Beach', image: 'https://images.unsplash.com/photo-1559628233-100c798642d4?w=400&q=75' },
  { name: 'Royal Palace', location: 'Phnom Penh', rating: '4.8', tags: ['City', 'Culture'], category: 'City', image: 'https://images.unsplash.com/photo-1609946860441-a51ffcf22089?w=400&q=75' },
  { name: 'Kulen Mountain', location: 'Siem Reap', rating: '4.6', tags: ['Nature', 'Adventure'], category: 'Nature', image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400&q=75' },
  { name: 'Koh Kong', location: 'Koh Kong Province', rating: '4.6', tags: ['Nature', 'Adventure'], category: 'Adventure', image: 'https://images.unsplash.com/photo-1518509562904-e7ef99cdcc86?w=400&q=75' },
  { name: 'Kampot Riverside', location: 'Kampot', rating: '4.5', tags: ['Nature', 'Culture'], category: 'Nature', image: 'https://images.unsplash.com/photo-1552733407-5d5c46c3bb3b?w=400&q=75' },
]

const filteredDestinations = computed(() => {
  if (activeTab.value === 'All') return destinations
  return destinations.filter(d => d.category === activeTab.value || d.tags.includes(activeTab.value))
})

const ongoingTrips = [
  { title: 'Phnom Penh → Koh Kong → Koh Rong', duration: '7-day itinerary', progress: 65, image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=600&q=75' },
  { title: 'Siem Reap Temple Circuit', duration: '4-day itinerary', progress: 30, image: '' },
]

const hiddenGems = [
  { name: 'Koh Kong', province: 'Koh Kong', description: "Cambodia's eco-adventure capital, Koh Kong boasts pristine rainforests, waterfalls, and mangrove estuaries teeming with wildlife.", image: 'https://images.unsplash.com/photo-1518509562904-e7ef99cdcc86?w=300&q=75' },
  { name: 'Kampot', province: 'Kampot', description: 'Charming riverside town famous for Kampot pepper, French colonial architecture, and tranquil sunset cruises.', image: 'https://images.unsplash.com/photo-1552733407-5d5c46c3bb3b?w=300&q=75' },
  { name: 'Banlung', province: 'Ratanakiri', description: "Gateway to volcanic crater lakes, indigenous villages, and lush jungle treks in Cambodia's wild northeast.", image: 'https://images.unsplash.com/photo-1509316975850-ff9c5deb0cd9?w=300&q=75' },
  { name: 'Kep', province: 'Kep', description: 'A sleepy seaside town known for its famous crab market, abandoned French villas, and views of Rabbit Island.', image: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=300&q=75' },
]

const upcomingEvents = [
  { title: 'Khmer New Year Festival', month: 'APR', day: '14', location: 'Nationwide', description: 'Celebrate the traditional Cambodian New Year with water splashing, temple visits, and cultural performances.', image: 'https://images.unsplash.com/photo-1533669955142-6a73332af4db?w=400&q=75' },
  { title: 'Angkor Wat Marathon', month: 'DEC', day: '01', location: 'Siem Reap', description: "Run through the ancient temple complex in one of Asia's most scenic marathon routes.", image: '' },
  { title: 'Water Festival (Bon Om Touk)', month: 'NOV', day: '14', location: 'Phnom Penh', description: 'Spectacular boat races on the Tonle Sap River with fireworks, concerts, and river parades.', image: 'https://images.unsplash.com/photo-1596422846543-75c6fc197f07?w=400&q=75' },
]

const travelTips = [
  { icon: '💵', title: 'Currency & Payment', description: 'US Dollars are widely accepted alongside Cambodian Riel. ATMs are available in major cities, but carry cash for rural areas.', bgClass: 'bg-green-50' },
  { icon: '🌡️', title: 'Best Time to Visit', description: 'November to April (dry season) is ideal. Expect hot days and cool evenings. Rainy season (May-Oct) offers lush landscapes and fewer crowds.', bgClass: 'bg-amber-50' },
  { icon: '🛺', title: 'Getting Around', description: 'Tuk-tuks are the most popular transport. Use ride-hailing apps like PassApp or Grab in Phnom Penh and Siem Reap.', bgClass: 'bg-blue-50' },
  { icon: '🏛️', title: 'Temple Etiquette', description: 'Dress modestly when visiting temples — cover shoulders and knees. Remove shoes before entering shrine areas.', bgClass: 'bg-purple-50' },
  { icon: '🍜', title: 'Must-Try Foods', description: 'Don\'t miss Fish Amok, Lok Lak, Nom Banh Chok (Khmer noodles), and fresh Kampot pepper crab at the coast.', bgClass: 'bg-red-50' },
  { icon: '📱', title: 'Stay Connected', description: 'Pick up a local SIM card (Smart or Cellcard) at the airport for affordable data. WiFi is widely available in cities.', bgClass: 'bg-cyan-50' },
]
</script>
