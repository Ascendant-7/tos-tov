<template>
  <main class="flex-1 h-screen overflow-y-auto bg-cream box-border font-sans custom-scrollbar">
    <CommunityView
      :active-comment-post-id="activeCommentPostId"
      :new-comment="newComment"
      @create-post="showCreatePostModal = true"
          ...
          >
            <div class="flex items-center justify-between gap-3">
              <div class="flex items-center gap-2 text-slate-700">
                ...
                <span v-if="selectedImages.length > 0" class="text-[12px] text-slate-500"
            ...
            <div v-if="selectedImages.length > 0" class="space-y-2">
              <div
                class="relative overflow-hidden rounded-xl border border-weather-border bg-white group"
              >
                <img
                ...
                <div
                  ...
                  :class="
                    currentImageIndex === index
                      ? 'border-sidebar-active ring-2 ring-sidebar-active/30'
                      : 'border-weather-border hover:border-slate-400'
                  "
